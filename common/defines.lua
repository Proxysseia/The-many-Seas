...
country = {
	...
	GOLD_TO_CASH_RATE = 22.0, -- Amount of money generated per gold unit
...
economy = {
	...
	BANKRUPCY_DURATION = 1, -- Years till a bankruptcy clears all loans
...
military = {
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.5, -- how little supply is acceptable before getting damage to STR
...
diplomacy = {
	...
	PRESTIGE_ADD_TO_SPHERE_BASE = 2.5,
	PRESTIGE_RELEASE_PUPPET_BASE = 2.5,
	...
	PRESTIGE_PRESTIGE_BASE = 2.5,
	PRESTIGE_CONCEDE_BASE = 1,
	PRESTIGE_STATUS_QUO_BASE = 2.5,
	PRESTIGE_ANNEX_BASE = 2,
	PRESTIGE_DEMAND_STATE_BASE = 2,
	PRESTIGE_CLEAR_UNION_SPHERE_BASE = 2.5, -- Prestige for asserting hegemony
	...
	PEACE_COST_GUNBOAT = 1, -- Cost of forcing a defaulting country to pay its debt
...
pops = {
	...
	LARGE_POPULATION_LIMIT = 14000000,
